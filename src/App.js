            ...
            {userCredit && (
              <div style={{marginTop: '24px', background: '#f0f8ff', padding: '16px', borderRadius: '8px', border: '2px solid #b8daff'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', paddingTop: '8px', borderTop: '1px solid #b8daff'}}>
                  <span style={{fontWeight: 'bold', color: (userCredit.creditLimit - userCredit.totalWagered) > 0 ? '#155724' : '#721c24'}}>
                    Credit Remaining:
                  </span>
                  <span style={{fontWeight: 'bold', fontSize: '18px', color: (userCredit.creditLimit - userCredit.totalWagered) > 0 ? '#155724' : '#721c24'}}>
                    ${(userCredit.creditLimit - userCredit.totalWagered).toFixed(2)}
                  </span>
                </div>
                {checkoutCalculations.totalStake > (userCredit.creditLimit - userCredit.totalWagered) && (
                  <div style={{
                    marginTop: '12px',
                    padding: '10px',
                    background: '#f8d7da',
                    ...
                    ⚠️ Warning: This wager exceeds your remaining credit by ${(checkoutCalculations.totalStake - (userCredit.creditLimit - userCredit.totalWagered)).toFixed(2)}
                  </div>
                )}
              </div>
            )}
