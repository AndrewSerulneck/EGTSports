...
/**
 * Extract team odds from The Odds API response
 ...
 * @param {string} teamId - The team ID from our JSON files (optional)
 * @param {string} teamName - The team name from The Odds API
